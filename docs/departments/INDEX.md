...
| **UI (restyle)** | — | `logiCard-ui-restyle` | Shell-chrome restyle (Character Select/buttons/lobby), **not yet merged**, pending human Editor review | [`ui/STATUS.md`](ui/STATUS.md) |
...
12. UI shell-chrome restyle dispatched 2026-08-19 (Character Select/buttons/lobby, non-HUD only) — landed on `logiCard-ui-restyle`, **not yet merged**, pending human Editor review.
