...
| **UI (bomber HUD)** | — | — | **Merged to master** (`67838a6`, 2026-08-21), Integrator-verified (196/196, 78/78); worktree removed | [`ui/STATUS.md`](ui/STATUS.md) |
...
8. ~~C36/Bomber `BoardView` breach visuals~~ — **merged `6a10534`** (2026-08-21), batchmode green on master post-merge (196/196, 73/73).
9. ~~C36/Bomber HUD board-anchored prompt~~ — **merged `67838a6`** (2026-08-21), batchmode green on master post-merge (196/196, 78/78). C36/Bomber wall-only verb is now feature-complete end-to-end (Sim → RoundPlayback → BoardView → HUD) except a real map-authored `BreachPoint` and Character-gating; see `DRAFT_HANDOFF.md` STATE block.
